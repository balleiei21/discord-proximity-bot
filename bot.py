...
# ----------------------------------------------------
# 2. ข้อมูลโครงสร้างหมวดหมู่และช่อง
# ----------------------------------------------------
CATEGORIES_DATA = {
    "꒰🌸꒱ Ⅰ・WELCOME": {
        "text": [
...
async def on_message(message):
    ...
    if message.content.strip() == "เริ่มงาน":
        ...
        # 5. สร้างหมวดหมู่ ช่องข้อความ ช่องเสียง และตั้งค่าสิทธิ์
        for cat_name, data in CATEGORIES_DATA.items():
            ...
            # --- สร้าง Voice Channels (ใช้ guild.create_voice_channel) ---
        ...
        if report_channel:
            ...
            # Embed 2: รายงานการจัดตั้งแบบสไตล์ Tag ในตัวอย่าง
            embed_summary = discord.Embed(
                title="⚔️ รายงานการจัดตั้งเซิร์ฟเวอร์สำเร็จ ⚔️",
                description=f"🏰 **{NEW_SERVER_NAME}** ได้รับการตั้งค่าโครงสร้างหมวดหมู่ ช่องแชท ช่องเสียง และยศประจำเซิร์ฟเวอร์เรียบร้อยแล้ว!",
            ...
            embed_summary.add_field(
                ...
                value="• `꒰💬꒱・general-chatೀ` | `꒰🍓꒱・strawberry-talkೀ` | `꒰📷꒱・galleryೀ` | `꒰🎮꒱・game-chatೀ` | `꒰🎵꒱・music-roomೀ` | `꒰🤍꒱・friend-zoneೀ`",
                inline=False
            )
            embed_summary.add_field(
                name="꒰🎀꒱ Ⅲ・SWEET EVENTS",
            ...
            embed_summary.add_field(
                ...
                value="• `꒰💬꒱・staff-chatೀ` | `꒰📋꒱・staff-boardೀ` | `꒰📢꒱・staff-newsೀ` | `꒰⚠️꒱・member-reportsೀ` | `꒰💡꒱・staff-ideasೀ` | `꒰📊꒱・server-logೀ`",
                inline=False
            )
            embed_summary.add_field(
                name="꒰👑꒱ Ⅵ・ADMIN ROOM",
            ...
            embed_summary.add_field(
                name="꒰🎧꒱ Ⅶ・VOICE LOUNGE",
                value="• **เสียง:** `꒰🍓꒱・Strawberry-Caféೀ` | `꒰🧁꒱・Whipping-Creamೀ` | `꒰🍰꒱・Cake-Roomೀ` | `꒰🌸꒱・Sweet-Roomೀ` | `꒰🎮꒱・Gaming-Roomೀ` | `꒰🔒꒱・Staff-Loungeೀ`",
                inline=False
            )
